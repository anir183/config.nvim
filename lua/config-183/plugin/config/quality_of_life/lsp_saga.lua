...
plugin.config = function(_, opts)
	...
	FUNCS.set_lsp_keymaps = function()
		...
		FUNCS.nmap("gr", "<CMD>Lspsaga finder<CR>", "[plugin/lspsaga]: [G]et [R]eferences", { buffer = 0 })
		FUNCS.nmap("gi", "<CMD>Lspsaga finder<CR>", "[plugin/lspsaga]: [G]et [I]mplementation", { buffer = 0 })
