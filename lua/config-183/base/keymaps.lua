...
if VARS.os == "unix" then
	...
	nmap("<leader>lv", "<CMD>" .. cmd .. "<CR>", "[base]: execute [L]og[V]im command")
	nmap("<leader>lt", "<CMD>" .. cmd .. " trace<CR>", "[base]: execute [L]ogvim [T]race command")
	nmap("<leader>ld", "<CMD>" .. cmd .. " debug<CR>", "[base]: execute [L]ogvim [D]ebug command")
	nmap("<leader>li", "<CMD>" .. cmd .. " info<CR>", "[base]: execute [L]ogvim [I]nfo command")
	nmap("<leader>lw", "<CMD>" .. cmd .. " warn<CR>", "[base]: execute [L]ogvim [W]arn command")
	nmap("<leader>le", "<CMD>" .. cmd .. " error<CR>", "[base]: execute [L]ogvim [E]rror command")
	nmap("<leader>lnt", "<CMD>" .. cmd .. " notrace<CR>", "[base]: execute [L]ogvim [N]o [T]race command")
	nmap("<leader>lnd", "<CMD>" .. cmd .. " nodebug<CR>", "[base]: execute [L]ogvim [N]o [D]ebug command")
	nmap("<leader>lni", "<CMD>" .. cmd .. " noinfo<CR>", "[base]: execute [L]ogvim [N]o [I]nfo command")
	nmap("<leader>lnw", "<CMD>" .. cmd .. " nowarn<CR>", "[base]: execute [L]ogvim [N]o [W]arn command")
	nmap("<leader>lne", "<CMD>" .. cmd .. " noerror<CR>", "[base]: execute [L]ogvim [N]o [E]rror command")
	nmap("<leader>l1", "<CMD>" .. cmd .. " one<CR>", "[base]: execute [L]og[V]im level [1] command")
	nmap("<leader>l2", "<CMD>" .. cmd .. " two<CR>", "[base]: execute [L]og[V]im level [2] command")
	nmap("<leader>l3", "<CMD>" .. cmd .. " three<CR>", "[base]: execute [L]og[V]im level [3] command")
	nmap("<leader>l4", "<CMD>" .. cmd .. " four<CR>", "[base]: execute [L]og[V]im level [4] command")
end
...
vim.api.nvim_create_autocmd("LspAttach", {
	...
	callback = function()
		...
		nmap("<leader>ic", vim.lsp.buf.incoming_calls, "[base/lsp]: [I]ncoming [C]alls", { buffer = 0 })
		nmap("<leader>oc", vim.lsp.buf.outgoing_calls, "[base/lsp]: [O]outgoing [C]alls", { buffer = 0 })
		nmap("<leader>ds", vim.lsp.buf.document_symbol, "[base/lsp]: [D]ocument [S]ymbol", { buffer = 0 })
		map({ "n", "x" }, "<leader>ca", vim.lsp.buf.code_action, "[base/lsp]: open [C]ode [A]ctions", { buffer = 0 })
		nmap("gD", vim.lsp.buf.declaration, "[base/lsp]: [G]oto [D]eclaration", { buffer = 0 })
